      ...
      <div className="w-full px-4 flex flex-col ">
        ...
        <div className="w-full pt-10 px-2 flex flex-col gap-2 ">
          ...
          <p className="px-3 text-lg md:text-xl text-slate-200 font-light tracking-wide leading-8 mb-10">
            ...
            things online. In 2022, I took the leap into freelancing, diving
            headfirst into the world of full-stack development. Over time, I
            honed my skills in the{" "}
            <span className="text-purple-700 font-bold">
              MERN stack, Next.js
            </span>{" "}
            , and Git, creating everything from real-time chat apps to
            AI-powered platforms. Along the way, I discovered a deep passion for
            3D web experiences, using{" "}
